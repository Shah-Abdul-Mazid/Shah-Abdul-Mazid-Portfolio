...
export const ATSResumePage: React.FC = () => {
    ...
    const pdfPath = '/resume/Shah_Abdul_Mazid_ATS_CV_Version_1.pdf';
    ...
    const handleDownloadPdf = async () => {
        ...
        try {
            ...
            if (res.ok && res.headers.get('content-type')?.includes('pdf')) {
                ...
                link.href = pdfPath;
                link.download = 'Shah_Abdul_Mazid_ATS_CV_Version_1.pdf';
                link.click();
                setGenerating(false);
                return;
            }
                            ...
                            <div className="pdf-viewer-modal">
                                <div className="pdf-viewer-header">
                                    <div className="pdf-viewer-title">
                                        <Eye size={16} />
                                        <span>ATS CV — Version 1 (PDF)</span>
                                    </div>
                                ...
                                <div className="pdf-viewer-body" style={{ display: 'flex', flexDirection: 'column' }}>
                                    <iframe src={`${pdfPath}#toolbar=1&navpanes=0&scrollbar=1`} title="ATS CV PDF" className="pdf-viewer-iframe" style={{ flex: 1, border: 'none' }} />
                                </div>
                            </div>
                        </div>
                    )}
