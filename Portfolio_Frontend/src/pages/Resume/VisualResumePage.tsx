...
export const VisualResumePage: React.FC = () => {
    ...
    const handleDownloadPdf = useCallback(async () => {
        ...
        // Try to fetch the static PDF as a real blob and force-download it
        try {
            ...
            // Fall through to dynamic html2canvas generator
        }

        // Fallback: render the live HTML to PDF via html2canvas
        try {
            if (cvRef.current) {
