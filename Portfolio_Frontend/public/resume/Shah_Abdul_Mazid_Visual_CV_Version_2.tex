...
\begin{itemize}
\item Published two research works spanning medical imaging and agricultural AI
\item Built enterprise document Q\&A, RAG, and knowledge retrieval systems
\item Developed ML systems for real-world Bangladesh traffic conditions
\item Designed multi-agent AI systems for complex enterprise workflows
\item Built end-to-end AI solutions from model development to production deployment
\end{itemize}
\newpage
\section{Professional Highlights}

\textbf{Published Research:} Two publications spanning medical imaging and agricultural AI, including IEEE ICCIT 2025 and Springer ICIDA 2025.

\vspace{1mm}

\textbf{Generative AI \& RAG:} Built enterprise document Q\&A, retrieval-augmented, and multi-agent AI systems.

\vspace{1mm}

\textbf{End-to-End AI:} Developed ML systems from model development and evaluation to backend integration and deployment.

\vspace{1mm}

\textbf{AI Automation:} Built n8n-based workflows integrating AI models, APIs, and external services.
...
\textbf{Authors:} \textbf{Shah Abdul Mazid}, Monisha Bani Nibedita Shuci, Mahia Mehrun Safa, Md. Ashikur Rahman Anik, Md. Omor Faruk Sejan, Khandhakar Shatu Moni, Md. Sazzad Hossain, Md. Adnan Morshed, Ahmed Wasif Reza\\[-0.5mm]
\textit{Innovations in Data Analytics}, Springer Nature, pp. 397-417, 2026.\\[-1mm]
...
\textbf{Authors:} Raiyan Gani, Yusuf Salehin, Md. Shakil Bhuiyan, \textbf{Shah Abdul Mazid}, Monisha Bani Nibedita Shuci, Shamim Ripon\\[-0.5mm]
\textit{2025 28th International Conference on Computer and Information Technology (ICCIT), IEEE, pp. 2235-2240}.\\[-1mm]
