...
\textbf{Published Research:} Two publications in medical imaging and agricultural AI, including ICCIT 2025 and Springer.
...
\textbf{End-to-End AI:} Developed ML systems spanning model development, backend integration, and production deployment.
