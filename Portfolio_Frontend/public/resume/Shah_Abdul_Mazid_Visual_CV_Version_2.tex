...
\item Developed and deployed AI/ML solutions using Generative AI, LLMs, RAG, and intelligent automation.

\item Built AI-powered applications and backend services using Python and FastAPI for scalable model integration.

\item Designed and implemented LLM-based workflows, conversational AI systems, and retrieval-augmented applications.

\item Integrated external APIs, AI models, and third-party services to deliver end-to-end AI solutions.

\item Optimized AI workflows and model pipelines for improved reliability, scalability, and operational efficiency.

\item Researched and applied emerging techniques in Generative AI, LLMs, RAG, and AI automation.
...
\item Built scalable FastAPI backend services for AI model deployment and integration.

\item Developed Text-to-Speech and voice generation systems for interactive applications.

\item Automated workflows using n8n to improve operational efficiency.

\item Integrated APIs and external services for end-to-end AI solutions.

\item Researched and implemented emerging Generative AI, LLM, and RAG techniques.
...
Built a full-stack enterprise AI platform for secure question answering over private documents, spreadsheets, and web content.

\begin{itemize}

\item Implemented RAG and multi-agent architecture.

\item Integrated Pinecone vector search and live data routing.

\item Added feedback memory, JWT authentication, and PII detection.

\item Developed Next.js frontend and FastAPI backend.

\item \textbf{Tech:} FastAPI, Next.js, React, TypeScript, OpenAI, Pinecone, RAG, AWS.
...
Developed an AI chatbot capable of answering HR policy questions from PDF documents using semantic retrieval and LLM generation.

\begin{itemize}

\item Implemented PDF processing and document retrieval.

\item Used vector search and sentence embeddings.

\item Developed interactive Streamlit interface.

\item \textbf{Tech:} Python, FastAPI, Streamlit, Pinecone, Llama 2, NLP.
...
Developed a deep learning system for vehicle detection and classification under Bangladesh traffic conditions.

\begin{itemize}

\item Implemented YOLO-based object detection.

\item Applied Grad-CAM/EigenCAM for model interpretation.

\item Built interactive inference using Streamlit and Gradio.

\item \textbf{Tech:} PyTorch, YOLO, OpenCV, NumPy, Pandas.
...
Developed a hybrid deep learning model combining MobileNet and DenseNet with CBAM attention for MRI-based brain tumor classification.

\begin{itemize}

\item Implemented preprocessing, augmentation, and classification.

\item Evaluated accuracy, precision, recall, and F1-score.

\item Applied Grad-CAM for model interpretability.

\item Deployed the model using Streamlit.
...
Developed an automated AI travel recommendation platform generating personalized travel plans.

\begin{itemize}

\item Integrated OpenAI for itinerary generation.

\item Automated workflows using n8n.

\item Integrated Google Maps, Google Sheets, and Stripe.
...
\textbf{MangoStack: A Lightweight, Interpretable Ensemble for Real-Time Mango Leaf Disease Diagnosis}\\[0.2mm]
\textbf{Authors:}Raiyan Gani,Yusuf Salehin,Md.Shakil Bhuiyan,\textbf{Shah Abdul Mazid},Monisha Bani Nibedita Shuci, Shamim Ripon\\[-0.8mm]
\textit{2025 28th International Conference on Computer and Information Technology (ICCIT), IEEE}, 
pp.~2235--2240.\\[-1mm]
DOI: \href{https://doi.org/10.1109/ICCIT68739.2025.11490181}{10.1109/ICCIT68739.2025.11490181}
